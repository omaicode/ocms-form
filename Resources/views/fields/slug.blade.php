<div class="mb-3 {{$viewClass['form-group']}}">
    ...
    <div class="{{$viewClass['field']}}">
        ...
        <div class="small mt-1" style="cursor: pointer" id="{{$id['name']}}_btn">
            <span class="text-muted me-1">@lang('form::messages.permalink'):</span>
            <span class="text-info">{{ url('/') }}/<span id="{{$id['slug']}}" data-title="@lang('form::messages.enter_slug')">{{ old($name['slug'], isset($value['slug']) ? $value['slug'] : '')}}</span></span>
        </div>
