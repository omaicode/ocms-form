...
use Modules\Form\Fields\Nullable;
use Modules\Form\Layout\Row;
use Modules\Form\Traits\HandleCascadeFields;
use Modules\Form\Traits\HasFields;
use Modules\Form\Traits\HasHooks;
...
class Form implements Renderable
{
    ...
    {
        \request()->session()->flash('toast_success', __('form::messages.created'));
    }
