...
use Modules\Form\Tools\Avatar;
use Modules\Form\Tools\Media;
use Modules\Form\Tools\Select;

/**
 * @method Modules\Form\Tools\Avatar        avatar($column, $label = '')
 * @method Modules\Form\Tools\Select        select($column, $label = '')
 * @method Modules\Form\Tools\Media         media($column, $label = '', $model_class)
 **/
